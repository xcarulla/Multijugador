sqlite3 users.db "CREATE TABLE IF NOT EXISTS `users` (`user_id` INTEGER PRIMARY KEY, `user_name` varchar(63),`user_mail` varchar(63), `user_password` varchar(255), `reset_token_hash` varchar(255),`reset_token_expires_at` DATETIME);"
